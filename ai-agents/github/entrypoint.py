...
from .github_agent_tool import GitHubAgentTool
...
async def create_tool_agent(
    *,
    ...
    try:
        ...
        logger.info(
            "GitHub plugin create_tool_agent: app_code=%s user_id=%s company_id=%s agent_id=%s app_config=%s",
            app_code,
            user_id,
            company_id,
            agent_id,
